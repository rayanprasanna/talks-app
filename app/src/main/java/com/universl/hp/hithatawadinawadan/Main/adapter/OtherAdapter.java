...
public class OtherAdapter extends BaseAdapter {
    ...
    public OtherAdapter(Context context, List<QuotesResponse> quotesResponses) {
    ...
    public OtherAdapter(Context context, List<QuotesResponse> quotesResponses, List<QuotesResponse> image_quotesResponses, ArrayList<String> image_pathList) {
        this.context = context;
        this.quotesResponses = quotesResponses;
