...
public class FansAdapter extends BaseAdapter {
    ...
    public FansAdapter(Context context, List<QuotesResponse> quotesResponses) {
    ...
    public FansAdapter(Context context, List<QuotesResponse> quotesResponses, List<QuotesResponse> image_quotesResponses, ArrayList<String> image_pathList) {
        this.context = context;
        this.quotesResponses = quotesResponses;
