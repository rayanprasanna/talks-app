...
public class HomeAdapter extends BaseAdapter {
    ...
    public void setImage_pathList(ArrayList<String> image_pathList) {
    ...
    public HomeAdapter(Context context, List<QuotesResponse> quotesResponses) {
    ...
    public HomeAdapter(Context context, List<QuotesResponse> quotesResponses, List<QuotesResponse> image_quotesResponses, ArrayList<String> image_pathList) {
        this.context = context;
        this.quotesResponses = quotesResponses;
        this.image_pathList = image_pathList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.count_of_favorite.setText(String.valueOf(Collections.frequency(getImage_pathList(),quotesResponses.get(position).photo)));
