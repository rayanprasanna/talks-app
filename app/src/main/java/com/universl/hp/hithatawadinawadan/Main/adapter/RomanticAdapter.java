...
public class RomanticAdapter extends BaseAdapter {
    ...
    public RomanticAdapter() {
    }

    public RomanticAdapter(Context context, List<QuotesResponse> quotesResponses) {
    ...
    public RomanticAdapter(Context context, List<QuotesResponse> quotesResponses, List<QuotesResponse> image_quotesResponses, ArrayList<String> image_pathList) {
        this.context = context;
        this.quotesResponses = quotesResponses;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("activity","romantic");
